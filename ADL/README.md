...
| ID      | Document                                       | Purpose                                                                                                                 |
| ------- | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| ADL-000 | Requirements Definition and Success Conditions | Defines the project motivation, intended value, high-level requirements, non-goals, and success conditions              |
