...
| [ミニモーター低速ギヤボックス（4速）](https://www.tamiya.com/japan/products/70189/index.html)                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Compact low-speed geared motor drive                 | Drives the rack-and-pinion stamp mechanism                              | Its compact size reduces interference with the moving mechanism and limits the mechanical load placed on the vertically mounted upper plate.    |
