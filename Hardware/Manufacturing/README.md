...
|---|---|---|---|
| Controller_Board | [`Controller_Board/gerber/`](../Controller_Board/gerber/) | [DigiKey MyList](https://www.digikey.jp/ja/mylists/list/P0VEJG3F78) | Pico-based local I²C control node |
